            ...
            if required not in template_capabilities:
                violations.append(
                    PolicyViolation(
                        ...
                        message=(
                            f"Required capability '{required}' missing from template "
                            f"capabilities: {template_capabilities}"
                        ),
                        suggested_action=(
                            f"Add '{required}' capability to template or remove from policy requirements"
                        ),
                    )
                )
