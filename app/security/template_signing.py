...
class TemplateSigningManager:
    ...
    def generate_keypair(self, key_id: str, private_key_path: Path, public_key_path: Optional[Path] = None) -> Tuple[Path, Path]:
    ...
    def verify_template_signature(self, template_path: Path) -> VerificationResult:
        ...
        try:
            ...
            logger.info(f"Template signature verified: {template_path} (key: {signature_data['key_id']}, trust: {trust_level})")
